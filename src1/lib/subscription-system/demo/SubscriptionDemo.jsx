...
const SubscriptionDemo = ({ Layout = null }) => {
  const { 
    currentPlan, 
    hasFeature, 
    getFeatureValue, 
      ...
      <div className="page-header mb-3 mb-md-4">
        <div className="row align-items-center">
          <div className="col-12 col-md-8">
            <h3 className="page-title mb-2 mb-md-0">Subscription System Demo</h3>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb mb-0">
                <li className="breadcrumb-item">
                  <Link to="/dashboard">Dashboard</Link>
                </li>
                <li className="breadcrumb-item active">Subscription Demo</li>
              </ol>
            </nav>
          </div>
                    ...
                    >
                      <div className="card-body">
                        <div className="d-flex justify-content-between align-items-start mb-2">
                          <h6 className="card-title mb-0">{feature.name}</h6>
                          {hasFeature(feature.path) ? (
                        ...
                        {hasFeature(feature.path) && (
                          <div className="mt-3">
                            <div className="d-flex justify-content-between align-items-center mb-2">
                              <span className="text-muted small">Feature Limit:</span>
                              <span className="badge bg-info text-white">
                                {getFeatureValue(feature.path) === 'unlimited' ? 'Unlimited' : getFeatureValue(feature.path)}
                              </span>
                            </div>
  ...
  // If Layout is provided, wrap the content
