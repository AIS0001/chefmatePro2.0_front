...
const CheckBillGstModal = ({ isOpen, customer, uptableList, onClose }) => {
  ...
  const handleTableHistory = async (tableName) => {
    ...
    fetchData("order_items_gst", setFinalData, "id", { table_number: tableName, status: "1" });
          ...
          <body>
            ...
            <div class="bill-bill-body">
              ...
              <table class="table">
                  ...
                  <tr >
                    <td class="header" >Inv No.  ${myfinalbilldata[0].id}</td>
...
const handleCancelBill = async () => {
  ...
  const handleSaveBill = async () => {
    try {
      ...
      //VAT POS  tax: taxAmount || 0, // ✅ Default to 0 if undefined
        tax: 0, // ✅ Default to 0 if undefined GST POS
      ...
      >
        ...
        <div className="row mt-4">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <CardComponent
              title="Running Tables List-GST Version"
...
export default CheckBillGstModal;