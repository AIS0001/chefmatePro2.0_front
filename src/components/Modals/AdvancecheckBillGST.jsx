...
const AdvanceCheckBillGstModal = ({ isOpen, customer, uptableList, onClose }) => {
...
const [paidAmount, setPaidAmount] = useState(0);
    ...
    const handleTableHistory = async (tableName) => {
        ...
        fetchData("advance_order_items_gst", setFinalData, "id", { table_number: tableName, status: "1" });
   ...
   useEffect(() => {
     ...
     if (TaxesData[0].included === "true") {
             ...
             //applicable for vat TAx only
      // taxValue = (subtotalAfterDiscount * TaxesData[0].taxvalue) / (100 + TaxesData[0].taxvalue);  only for VAT TAx
    ...
    const handleBillHistory = async () => {
        navigate(`/reports/advanceorderreportgst`);
    };
    const handlePrintClick = async (itemId) => {
        try {
            ...
            const invId = itemId;
            //alert(invId);
            // Fetch the advance_final_bill and order_items details for the given itemId
            const myfinalbilldata = await fetchData("advance_final_bill", setFinalBillData, "id", { id: invId });
            const myOrderItemsData = await fetchData("advance_order_items_gst", setOrderItemsData, "id", { invoice_number: invId });
        ...
        <html>
          ...
          <body>
            ...
            <div class="bill-body">
              ...
              <span> After Discount:  ₹${myfinalbilldata[0].subtotal_afterdiscount}</span><br>
    ...
    const handleSaveBill = async () => {
        try {
           ...
           // const response = await axios.post('/api/save-advance-final-bill', payload);
      ...
      await updateData("advance_order_items_gst", {
    ...
    const handleGenetotal_priceBill = async () => {
        ...
        // alert(billId);
        // await fetchData("advance_final_bill", setFinalBillData, "id", { id: billId });
            ...
            >
                ...
                <div className="row mt-4">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <CardComponent
                            title="Advance Booking List-GST Version"
                                        ...
                                        TotalTablelist.map((tables, index) => (
                                            ...
                                            >
                                                <div
                                                    ...
                                                    style={{
                                                        backgroundColor:
                                                            tables.status === 0 ? "#bf1402" : "#dc3355", // Green for available, red for occupied
                                                        color: "white",
                                                    }}
                                                >
                                                    <img
...
export default AdvanceCheckBillGstModal;
